...
if __name__ == '__main__':
    ...
    encrypted = caesar_cipher(text, 3, True)    # 암호화
    print(encrypted)
    decrypted = caesar_cipher(encrypted, 3, False)    # 복호화
    print(decrypted)

    encrypted = caesar_cipher(text,False)    # 암호화
    print(encrypted)
    ...
    print(encrypted)
    decrypted = caesar_cipher(text, 3, False)
    print(decrypted)

    text = 'Hello, World'
    encrypted = caesar_cipher(text, 3, False)
    print(encrypted)
    decrypted = caesar_cipher(text, 3)
    print(decrypted)